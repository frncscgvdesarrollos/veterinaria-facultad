module.exports = [
"[project]/src/app/actions/data:93276f [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$93276f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:93276f [app-ssr] (ecmascript) <text/javascript>"); // Importamos la acción
'use client';
;
;
;
...
function SolicitarTurnoConsulta() {
    ...
    const handleSubmit = async (e)=>{
        ...
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$93276f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["solicitarTurno"])(user.uid, {
                ...formData,
                tipo: 'consulta'
            });
            if (result.success) {
...
//# sourceMappingURL=_590449e9._.js.map