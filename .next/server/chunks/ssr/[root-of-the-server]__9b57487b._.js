...
"[project]/.next-internal/server/app/mis-turnos/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions.js [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/mis-turnos/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions.js [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUserTurnos(userId) {
    ...
    const firestore = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].firestore();
    try {
        // CORRECCIÓN 2: Se elimina el .orderBy() para evitar la necesidad de un índice compuesto inmediato.
        // La consulta ahora es más simple y tiene más probabilidades de éxito sin configuración adicional.
        // Para una solución a largo plazo, se debe crear el índice en Firestore.
        const turnosSnap = await firestore.collection('turnos').where('userId', '==', userId).get();
        if (turnosSnap.empty) {
            return [];
        }
        // Procesar y ordenar los datos en el servidor después de obtenerlos
        const turnosData = turnosSnap.docs.map((doc)=>({
                id: doc.id,
                ...doc.data()
            }));
        // Ordenar por fecha de creación descendente aquí, en el código
        turnosData.sort((a, b)=>(b.createdAt?.toMillis() || 0) - (a.createdAt?.toMillis() || 0));
                    ...
                    children: [
                        ...
                        turnos.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: turnos.map((turno)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "bg-white p-6 rounded-2xl shadow-lg border border-gray-200/80 transform hover:scale-[1.02] transition-transform duration-300",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b57487b._.js.map