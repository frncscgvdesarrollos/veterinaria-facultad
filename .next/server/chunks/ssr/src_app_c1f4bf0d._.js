...
"[project]/src/app/actions/data:4ec425 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$4ec425__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:4ec425 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function AccionesTurnoUsuario({ turno }) {
    ...
    const handleCancel = async ()=>{
        ...
        setSuccess('');
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$4ec425__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelarTurnoUsuario"])(turno.id);
            if (result.success) {
...
//# sourceMappingURL=src_app_c1f4bf0d._.js.map