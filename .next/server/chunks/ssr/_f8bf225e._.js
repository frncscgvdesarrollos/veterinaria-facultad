...
// import Modal from '@/app/components/Modal'; // Comentado - No se usa por ahora
...
;
;
// const ReCAPTCHA = dynamic(() => import('react-google-recaptcha'), { ssr: false }); // Comentado
...
function LoginPage() {
    ...
    // const recaptchaRef = useRef(); // Comentado
    ...
    // const [isClient, setIsClient] = useState(false); // Comentado
    ...
    const handleFormSubmit = async (e)=>{
        ...
        setError(null);
        if (isRegistering) {
            // Lógica de registro movida aquí, eliminando el modal y reCAPTCHA
    ...
    // ELIMINADO: handleFinalRegister ya no es necesario, su lógica se fusionó.
    ...
    // const siteKey = process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY || "YOUR_SITE_KEY"; // Comentado
...
//# sourceMappingURL=_f8bf225e._.js.map