...
const AuthProvider = ({ children })=>{
    ...
    const logout = ()=>{
        // Limpiamos el estado local al cerrar sesión
        setUser(null);
        setUserRole(null);
        ...
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], async (currentUser)=>{
            ...
            if (currentUser) {
                try {
                    ...
                    setUser(currentUser);
                    // Asignamos el rol desde el claim, o 'dueño' si no existe
                    setUserRole(roleFromClaim || 'dueño');
                } catch (error) {
                    console.error("Error al obtener el token o los claims:", error);
                    // En caso de error, dejamos al usuario sin un rol especial
                    setUser(currentUser);
                    setUserRole('dueño');
                }
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3fa6dcc9._.js.map