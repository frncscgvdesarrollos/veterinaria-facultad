...
"[project]/src/app/turnos/peluqueria/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PeluqueriaPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PeluqueriaPage.useEffect": ()=>{
            if (!user) return;
            const fetchMascotas = {
                "PeluqueriaPage.useEffect.fetchMascotas": async ()=>{
                    try {
                        ...
                        const listaMascotas = querySnapshot.docs.map({
                            "PeluqueriaPage.useEffect.fetchMascotas.listaMascotas": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["PeluqueriaPage.useEffect.fetchMascotas.listaMascotas"]);
            ...
            }["PeluqueriaPage.useEffect.fetchMascotas"];
            fetchMascotas();
        }
    }["PeluqueriaPage.useEffect"], [
        user
...
_s(PeluqueriaPage, "N/+7QAW8RQN8uW5SfPQ+Ym901kw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
_c = PeluqueriaPage;
var _c;
__turbopack_context__.k.register(_c, "PeluqueriaPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_10cbfb25._.js.map