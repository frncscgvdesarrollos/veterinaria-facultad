...
const AuthProvider = (param)=>{
    ...
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuth"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
    ...
    const logout = ()=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOut"])(auth);
    };
...
_s1(AuthProvider, "Y5F2pQQk2LZA5WRO2+bvRm5iRuo=");
_c = AuthProvider;
var _c;
...
function Header() {
    _s();
    const { currentUser, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Header, "irPLFJ3DqMTL8RNRVsehGT4mySY=", false, function() {
    return [
...
const ConnectionStatus = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConnectionStatus.useEffect": ()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
                const connectedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, ".info/connected");
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(connectedRef, {
                    "ConnectionStatus.useEffect.unsubscribe": (snap)=>{
                        const status = snap.val() === true;
                        setIsConnected(status);
                        console.log("Firebase connection status:", status ? "Connected" : "Disconnected");
                    }
                }["ConnectionStatus.useEffect.unsubscribe"]);
                return ({
                    "ConnectionStatus.useEffect": ()=>{
                        unsubscribe();
                    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "px-4 py-2 rounded-full text-white shadow-lg text-sm font-semibold transition-colors duration-300 ".concat(isConnected ? 'bg-green-500' : 'bg-red-500'),
            children: isConnected ? 'Conectado a Firebase' : 'Desconectado'
        }, void 0, false, {
...
_s(ConnectionStatus, "X8xpX3k6aXdyWkMXjkSdizyzA6Y=");
_c = ConnectionStatus;
...
//# sourceMappingURL=src_9c232c99._.js.map