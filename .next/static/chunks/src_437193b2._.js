...
"[project]/src/app/data:afcaae [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$afcaae__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:afcaae [app-client] (ecmascript) <text/javascript>");
;
     ...
     */ const registerWithEmailAndPassword = async (email, password, profileData)=>{
        try {
            ...
            if (user) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$afcaae__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["completarPerfil"])(user.uid, profileData);
            }
            return result;
        } catch (error) {
...
//# sourceMappingURL=src_437193b2._.js.map