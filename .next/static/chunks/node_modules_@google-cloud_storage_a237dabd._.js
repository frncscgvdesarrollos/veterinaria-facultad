 ...
 */ function formatAsUTCISO(dateTimeToFormat) {
    let includeTime = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, dateDelimiter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : '', timeDelimiter = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : '';
    ...
    let resultString = "".concat(year.toString().padStart(4, '0')).concat(dateDelimiter).concat(month.toString().padStart(2, '0')).concat(dateDelimiter).concat(day.toString().padStart(2, '0'));
    if (includeTime) {
        resultString = "".concat(resultString, "T").concat(hour.toString().padStart(2, '0')).concat(timeDelimiter).concat(minute.toString().padStart(2, '0')).concat(timeDelimiter).concat(second.toString().padStart(2, '0'), "Z");
    }
    return resultString;
}
/**
 ...
 */ function getRuntimeTrackingString() {
    ...
    globalThis.Deno.version.deno) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        return "gl-deno/".concat(globalThis.Deno.version.deno);
    } else {
        return "gl-node/".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions.node);
    }
}
/**
...
class Util {
    ...
    _getDefaultHeaders(gcclGcsCmd) {
        const headers = {
            ...
            'x-goog-api-client': "".concat((0, util_js_1.getRuntimeTrackingString)(), " gccl/").concat(packageJson.version, "-").concat((0, util_js_1.getModuleFormat)(), " gccl-invocation-id/").concat(uuid.v4())
        };
        if (gcclGcsCmd) {
            headers['x-goog-api-client'] += " gccl-gcs-cmd/".concat(gcclGcsCmd);
        }
        return headers;
    }
    constructor(){
...
class Service {
    ...
    request_(reqOpts, callback) {
        ...
        reqOpts.headers = {
            ...
            'x-goog-api-client': "".concat((0, util_js_2.getRuntimeTrackingString)(), " gccl/").concat(pkg.version, "-").concat((0, util_js_2.getModuleFormat)(), " gccl-invocation-id/").concat(uuid.v4())
        };
        if (reqOpts[util_js_1.GCCL_GCS_CMD_KEY]) {
            reqOpts.headers['x-goog-api-client'] += " gccl-gcs-cmd/".concat(reqOpts[util_js_1.GCCL_GCS_CMD_KEY]);
        }
...
class Upload extends stream_1.Writable {
     ...
     */ _final() {
        let fireFinishEvent = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ()=>{};
     ...
     */ _write(chunk, encoding) {
        let readCallback = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ()=>{};
     ...
     */ async *upstreamIterator() {
        let limit = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Infinity;
    ...
    async createURIAsync() {
        ...
        let googAPIClient = "".concat((0, util_js_1.getRuntimeTrackingString)(), " gccl/").concat(packageJson.version, "-").concat((0, util_js_1.getModuleFormat)(), " gccl-invocation-id/").concat(this.currentInvocationId.uri);
        if (__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f")) {
            googAPIClient += " gccl-gcs-cmd/".concat(__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f"));
        }
    ...
    async startUploading() {
        ...
        if (this.offset < this.numBytesWritten) {
            ...
            const message = "The offset is lower than the number of bytes written. The server has ".concat(this.offset, " bytes and while ").concat(this.numBytesWritten, " bytes has been uploaded - thus ").concat(delta, " bytes are missing. Stopping as this could result in data loss. Initiate a new upload to continue.");
        ...
        let googAPIClient = "".concat((0, util_js_1.getRuntimeTrackingString)(), " gccl/").concat(packageJson.version, "-").concat((0, util_js_1.getModuleFormat)(), " gccl-invocation-id/").concat(this.currentInvocationId.chunk);
        if (__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f")) {
            googAPIClient += " gccl-gcs-cmd/".concat(__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f"));
        }
        const headers = {
        ...
        if (multiChunkMode) {
            ...
            headers['Content-Range'] = "bytes ".concat(this.offset, "-").concat(endingByte, "/").concat(totalObjectSize);
        } else {
            headers['Content-Range'] = "bytes ".concat(this.offset, "-*/").concat(this.contentLength);
        }
        const reqOpts = {
            method: 'PUT',
            url: this.uri,
     ...
     */ async checkUploadStatus() {
        ...
        let googAPIClient = "".concat((0, util_js_1.getRuntimeTrackingString)(), " gccl/").concat(packageJson.version, "-").concat((0, util_js_1.getModuleFormat)(), " gccl-invocation-id/").concat(this.currentInvocationId.checkUploadStatus);
        if (__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f")) {
            googAPIClient += " gccl-gcs-cmd/".concat(__classPrivateFieldGet(this, _Upload_gcclGcsCmd, "f"));
        }
        const opts = {
     ...
     */ attemptDelayedRetry(resp) {
        if (this.numRetries < this.retryOptions.maxRetries) {
            if (resp.status === NOT_FOUND_STATUS_CODE && this.numChunksReadInRequest === 0) {
                ...
                const retryDelay = this.getRetryDelay();
                if (retryDelay <= 0) {
                    this.destroy(new Error("Retry total time limit exceeded - ".concat(JSON.stringify(resp.data))));
                    return;
                }
            ...
            this.destroy(new Error("Retry limit exceeded - ".concat(JSON.stringify(resp.data))));
        }
    }
    /**
    ...
    constructor(cfg){
        ...
        this.apiEndpoint = "https://storage.".concat(universe);
        if (cfg.apiEndpoint && cfg.apiEndpoint !== this.apiEndpoint) {
            ...
            const isSubDomainOfUniverse = hostname.slice(-(universe.length + 1)) === ".".concat(universe);
            const isSubDomainOfDefaultUniverse = hostname.slice(-(google_auth_library_1.DEFAULT_UNIVERSE.length + 1)) === ".".concat(google_auth_library_1.DEFAULT_UNIVERSE);
        ...
        this.baseURI = "".concat(this.apiEndpoint, "/upload/storage/v1/b");
...
class URLSigner {
    getSignedUrl(cfg) {
        ...
        if (cfg.cname) {
            ...
            customHost = "https://".concat(this.bucket.name, ".storage.").concat(this.storage.universeDomain);
        }
    ...
    getSignedUrlV4(config) {
        ...
        const credentialScope = "".concat(datestamp, "/auto/storage/goog4_request");
        const sign = async ()=>{
            var _a;
            const credentials = await this.auth.getCredentials();
            const credential = "".concat(credentials.client_email, "/").concat(credentialScope);
     ...
     */ getCanonicalHeaders(headers) {
        ...
        .map((param)=>{
            let [headerName, value] = param;
            return [
                headerName.toLowerCase(),
                value
            ];
        }).sort((a, b)=>a[0].localeCompare(b[0]));
        return sortedHeaders.filter((param)=>{
            let [, value] = param;
            ...
            const canonicalValue = "".concat(value).trim().replace(/\s{2,}/g, ' ');
    ...
    getCanonicalQueryParams(query) {
        return (0, util_js_1.objectEntries)(query).map((param)=>{
            let [key, value] = param;
            return [
                (0, util_js_1.encodeURI)(key, true),
                (0, util_js_1.encodeURI)(value, true)
            ];
        }).sort((a, b)=>a[0] < b[0] ? -1 : 1).map((param)=>{
            let [key, value] = param;
    ...
    parseExpires(expires) {
        let current = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : new Date();
...
const CRC32C_EXCEPTION_MESSAGES = {
    INVALID_INIT_BASE64_RANGE: (l)=>"base64-encoded data expected to equal 4 bytes, not ".concat(l),
    INVALID_INIT_BUFFER_LENGTH: (l)=>"Buffer expected to equal 4 bytes, not ".concat(l),
    INVALID_INIT_INTEGER: (l)=>"Number expected to be a safe, unsigned 32-bit integer, not ".concat(l)
};
 ...
 */ class File extends index_js_1.ServiceObject {
     ...
     */ copy(destination, optionsOrCallback, callback) {
        ...
        this.request({
            method: 'POST',
            uri: "/rewriteTo/b/".concat(destBucket.name, "/o/").concat(encodeURIComponent(newFile.name)),
            qs: query,
            json: options,
            headers
        }, (err, resp)=>{
     ...
     */ createReadStream() {
        ...
        const makeRequest = ()=>{
            ...
            if (rangeRequest) {
                ...
                headers.Range = "bytes=".concat(tailRequest ? end : "".concat(start, "-").concat(end));
            }
            const reqOpts = {
                uri: '',
                headers,
     ...
     */ generateSignedPostPolicyV4(optionsOrCallback, cb) {
        ...
        const sign = async ()=>{
            ...
            const credential = "".concat(client_email, "/").concat(todayISO, "/auto/storage/goog4_request");
            fields = {
                ...fields,
                bucket: this.bucket.name,
                key: this.name,
            ...
            try {
                ...
                if (this.storage.customEndpoint) {
                    ...
                    url = "https://".concat(this.bucket.name, ".storage.").concat(universe, "/");
                } else if (options.bucketBoundHostname) {
                    url = "".concat(options.bucketBoundHostname, "/");
                } else {
                    url = "https://storage.".concat(universe, "/").concat(this.bucket.name, "/");
                }
                return {
                    url,
                    fields
     ...
     */ isPublic(callback) {
        ...
        const headers = allInterceptors.reduce((acc, curInterceptor)=>{
            const currentHeaders = curInterceptor.request({
                uri: "".concat(this.storage.apiEndpoint, "/").concat(this.bucket.name, "/").concat(encodeURIComponent(this.name))
            });
     ...
     * ```
     */ publicUrl() {
        return "".concat(this.storage.apiEndpoint, "/").concat(this.bucket.name, "/").concat(encodeURIComponent(this.name));
    }
    /**
     ...
     */ moveFileAtomic(destination, optionsOrCallback, callback) {
        ...
        this.request({
            method: 'POST',
            uri: "/moveTo/o/".concat(encodeURIComponent(newFile.name)),
            qs: query,
            json: options
        }, (err, resp)=>{
            this.storage.retryOptions.autoRetry = this.instanceRetryValue;
     ...
     *
     * @private
     */ startSimpleUpload_(dup) {
        let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        var _a;
        (_a = options.metadata) !== null && _a !== void 0 ? _a : options.metadata = {};
        const apiEndpoint = this.storage.apiEndpoint;
        const bucketName = this.bucket.name;
        const uri = "".concat(apiEndpoint, "/upload/storage/v1/b/").concat(bucketName, "/o");
        const reqOpts = {
            qs: {
                name: this.name
            },
 ...
 */ async function _File_validateIntegrity(hashCalculatingStream) {
    let verify = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    if (dataMismatch) {
        ...
        try {
            ...
            message = "".concat(FileExceptionMessages.UPLOAD_MISMATCH_DELETE_FAIL).concat(error.message);
            errors.push(error);
        }
 ...
 */ class Bucket extends index_js_1.ServiceObject {
     ...
     */ createNotification(topic, optionsOrCallback, callback) {
        ...
        body.topic = "//pubsub.".concat(this.storage.universeDomain, "/") + body.topic;
     ...
     */ getFiles(queryOrCallback, callback) {
        ...
        if (query.fields && query.autoPaginate && !query.fields.includes('nextPageToken')) {
            query.fields = "".concat(query.fields, ",nextPageToken");
        }
        this.request({
            uri: '/o',
            qs: query
     ...
     */ makeAllFilesPublicPrivate_(optionsOrCallback, callback) {
        ...
        this.getFiles(options).then((param)=>{
            let [files] = param;
            const limit = (0, p_limit_1.default)(MAX_PARALLEL_LIMIT);
 ...
 */ class HmacKey extends index_js_1.ServiceObject {
     ...
     */ constructor(storage, accessId, options){
        ...
        super({
            parent: storage,
            id: accessId,
            baseUrl: "/projects/".concat(projectId, "/hmacKeys"),
            methods
        });
        this.storage = storage;
        this.instanceRetryValue = storage.retryOptions.autoRetry;
 ...
 */ class Storage extends index_js_1.Service {
     ...
     */ constructor(options = {}){
        ...
        let apiEndpoint = "https://storage.".concat(universe);
        ...
        // Note: EMULATOR_HOST is an experimental configuration variable. Use apiEndpoint instead.
        const baseUrl = EMULATOR_HOST || "".concat(options.apiEndpoint, "/storage/v1");
        const config = {
 ...
 */ class XMLMultiPartUploadHelper {
     ...
     */ async initiateUpload() {
        ...
        const url = "".concat(this.baseUrl, "?uploads");
     ...
     */ async uploadPart(partNumber, chunk, validation) {
        const url = "".concat(this.baseUrl, "?partNumber=").concat(partNumber, "&uploadId=").concat(this.uploadId);
     ...
     */ async completeUpload() {
        const url = "".concat(this.baseUrl, "?uploadId=").concat(this.uploadId);
        ...
        const body = "<CompleteMultipartUpload>".concat(this.xmlBuilder.build(parts), "</CompleteMultipartUpload>");
        return (0, async_retry_1.default)(async (bail)=>{
            try {
                const res = await this.authClient.request({
    ...
    constructor(bucket, fileName, uploadId, partsMap){
        ...
        this.baseUrl = "https://".concat(bucket.name, ".").concat(new URL(this.bucket.storage.apiEndpoint).hostname, "/").concat(fileName);
...
_XMLMultiPartUploadHelper_instances = new WeakSet(), _XMLMultiPartUploadHelper_setGoogApiClientHeaders = function _XMLMultiPartUploadHelper_setGoogApiClientHeaders() {
    ...
    for (const [key, value] of Object.entries(headers)){
        if (key.toLocaleLowerCase().trim() === 'x-goog-api-client') {
            ...
            if (!value.includes(GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED)) {
                headers[key] = "".concat(value, " gccl-gcs-cmd/").concat(GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED);
            }
    ...
    if (!headerFound) {
        headers['x-goog-api-client'] = "".concat((0, util_js_2.getRuntimeTrackingString)(), " gccl/").concat(packageJson.version, " gccl-gcs-cmd/").concat(GCCL_GCS_CMD_FEATURE.UPLOAD_SHARDED);
    }
 ...
 */ class TransferManager {
     ...
     */ async downloadManyFiles(filesOrFolder) {
        ...
        const stripRegexString = options.stripPrefix ? "^".concat(options.stripPrefix) : EMPTY_REGEX;
     ...
     */ async uploadFileInChunks(filePath) {
        let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, generator = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : defaultMultiPartGenerator;
...
//# sourceMappingURL=node_modules_%40google-cloud_storage_a237dabd._.js.map