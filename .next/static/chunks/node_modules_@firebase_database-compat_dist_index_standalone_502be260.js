 ...
 */ class AppCheckTokenProvider {
    ...
    notifyForInvalidToken() {
        warn$1('Provided AppCheck credentials for the app named "'.concat(this.appName, '" ') + 'are invalid. This usually indicates your app was not initialized correctly.');
    }
 ...
 */ class Query {
    on(eventType, callback, cancelCallbackOrContext, context) {
        ...
        const cancelCallback = (_ret_cancel = ret.cancel) === null || _ret_cancel === void 0 ? void 0 : _ret_cancel.bind(ret.context);
        switch(eventType){
            case 'value':
    ...
    startAt() {
        let value = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, name = arguments.length > 1 ? arguments[1] : void 0;
 ...
 * @param version - custom version e.g. firebase-admin version
 * @param customAuthImpl - custom auth implementation
 */ function initStandalone$1(param) {
    let { app, url, version, customAuthImpl, customAppCheckImpl, namespace, nodeAdmin = false } = param;
 ...
 */ function initStandalone(app, url, version) {
    let nodeAdmin = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
