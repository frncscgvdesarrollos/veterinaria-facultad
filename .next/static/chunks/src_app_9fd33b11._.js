...
"[project]/src/app/actions/data:026b1e [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$026b1e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:026b1e [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AccionesTurnoUsuario(param) {
    ...
    const handleCancel = async ()=>{
        ...
        setSuccess('');
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$026b1e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelarTurnoUsuario"])(turno.id);
            if (result.success) {
...
//# sourceMappingURL=src_app_9fd33b11._.js.map