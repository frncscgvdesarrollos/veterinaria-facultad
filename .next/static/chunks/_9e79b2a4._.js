...
function MisDatosPage() {
    _s();
    const { user, loading, changePassword } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handlePasswordSubmit = async (e)=>{
        ...
        try {
            ...
            console.error(error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.code === 'auth/wrong-password' ? 'La contraseña actual es incorrecta.' : 'Hubo un error al cambiar la contraseña.', {
                id: toastId
            });
        }
    };
...
_s(MisDatosPage, "mldOIe/EyfUrcnYRVBzKUhDgN1M=", false, function() {
    return [
...
//# sourceMappingURL=_9e79b2a4._.js.map