...
/*! firebase-admin v13.5.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
 ...
 */ class FirebaseError extends Error {
    /** @returns The error code. */ get code() {
        var _this_errorInfo;
        return (_this_errorInfo = this.errorInfo) === null || _this_errorInfo === void 0 ? void 0 : _this_errorInfo.code;
    }
    /** @returns The error message. */ get message() {
        var _this_errorInfo;
        return (_this_errorInfo = this.errorInfo) === null || _this_errorInfo === void 0 ? void 0 : _this_errorInfo.message;
    }
 ...
 */ class PrefixedFirebaseError extends FirebaseError {
     ...
     */ hasCode(code) {
        return "".concat(this.codePrefix, "/").concat(code) === this.code;
    }
    /**
     ...
     */ constructor(codePrefix, code, message){
        super({
            code: "".concat(codePrefix, "/").concat(code),
            message
        });
 ...
 */ class FirebaseAuthError extends PrefixedFirebaseError {
     ...
     */ static fromServerError(serverErrorCode, message, rawServerResponse) {
        ...
        if (clientCodeKey === 'INTERNAL_ERROR' && typeof rawServerResponse !== 'undefined') {
            try {
                error.message += ' Raw server response: "'.concat(JSON.stringify(rawServerResponse), '"');
            } catch (e) {
 ...
 */ class ApplicationDefaultCredential {
    ...
    getQuotaProjectId() {
        if (!this.quotaProjectId) {
            var _this_authClient;
            this.quotaProjectId = (_this_authClient = this.authClient) === null || _this_authClient === void 0 ? void 0 : _this_authClient.quotaProjectId;
        }
  ...
  */ async getIDToken(audience) {
    ...
    async getServiceAccountEmail() {
        ...
        this.accountId = clientEmail !== null && clientEmail !== void 0 ? clientEmail : '';
        return Promise.resolve(this.accountId);
    }
 ...
 */ function populateCredential(credentials) {
    const accessToken = credentials === null || credentials === void 0 ? void 0 : credentials.access_token;
    const expiryDate = credentials === null || credentials === void 0 ? void 0 : credentials.expiry_date;
    ...
    refreshToken() {
        ...
        return Promise.resolve(this.credential_.getAccessToken()).then((result)=>{
            ...
            if (!validator.isNonNullObject(result) || typeof result.expires_in !== 'number' || typeof result.access_token !== 'string') {
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_CREDENTIAL, 'Invalid access token generated: "'.concat(JSON.stringify(result), '". Valid access ') + 'tokens must be an object with the "expires_in" (number) and "access_token" ' + '(string) properties.');
            }
            const token = {
            ...
            errorMessage = 'Credential implementation provided to initializeApp() via the ' + '"credential" property failed to fetch a valid Google OAuth2 access token with the ' + 'following error: "'.concat(errorMessage, '".');
 ...
 */ class FirebaseApp {
     ...
     */ delete() {
        var // Also remove the instance from the AppStore. This is needed to support the existing
        // app.delete() use case. In the future we can remove this API, and deleteApp() will
        // become the only way to tear down an App.
        _this_appStore;
        this.checkDestroyed_();
        (_this_appStore = this.appStore) === null || _this_appStore === void 0 ? void 0 : _this_appStore.removeApp(this.name);
    ...
    checkDestroyed_() {
        if (this.isDeleted_) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.APP_DELETED, 'Firebase app named "'.concat(this.name_, '" has already been deleted.'));
        }
    }
    constructor(options, name, autoInit = false, appStore){
        ...
        if (!validator.isNonNullObject(this.options_)) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'Invalid Firebase app options passed as the first argument to initializeApp() for the ' + 'app named "'.concat(this.name_, '". Options must be a non-null object.'));
        }
        ...
        if (typeof credential !== 'object' || credential === null || typeof credential.getAccessToken !== 'function') {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'Invalid Firebase app options passed as the first argument to initializeApp() for the ' + 'app named "'.concat(this.name_, '". The "credential" property must be an object which implements ') + 'the Credential interface.');
        }
...
/*! firebase-admin v13.5.0 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
"use strict";
/*!
 * @license
...
class AppStore {
    initializeApp(options) {
        let appName = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_APP_NAME;
        ...
        if (currentApp.autoInit() !== autoInit) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'A Firebase app named "'.concat(appName, '" already exists with a different configuration.'));
        }
        if (autoInit) {
        ...
        if (!fastDeepEqual(options, currentAppOptions)) {
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.DUPLICATE_APP, 'A Firebase app named "'.concat(appName, '" already exists with a different configuration.'));
        }
        return currentApp;
    }
    getApp() {
        let appName = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : DEFAULT_APP_NAME;
        validateAppNameFormat(appName);
        if (!this.appStore.has(appName)) {
            let errorMessage = appName === DEFAULT_APP_NAME ? 'The default Firebase app does not exist. ' : 'Firebase app named "'.concat(appName, '" does not exist. ');
 ...
 */ function validateAppOptionsSupportDeepEquals(requestedOptions, existingApp) {
    ...
    if (typeof requestedOptions.httpAgent !== 'undefined') {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'Firebase app named "'.concat(existingApp.name, '" already exists and initializeApp was') + ' invoked with an optional http.Agent. The SDK cannot confirm the equality' + ' of http.Agent objects with the existing app. Please use getApp or getApps to reuse' + ' the existing app instead.');
    } else if (typeof existingApp.options.httpAgent !== 'undefined') {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'An existing app named "'.concat(existingApp.name, '" already exists with a different') + ' options configuration: httpAgent.');
    }
    // Credential checks.
    if (typeof requestedOptions.credential !== 'undefined') {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'Firebase app named "'.concat(existingApp.name, '" already exists and initializeApp was') + ' invoked with an optional Credential. The SDK cannot confirm the equality' + ' of Credential objects with the existing app. Please use getApp or getApps' + ' to reuse the existing app instead.');
    }
    if (existingApp.customCredential()) {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_OPTIONS, 'An existing app named "'.concat(existingApp.name, '" already exists with a different') + ' options configuration: Credential.');
    }
}
/**
 ...
 */ function validateAppNameFormat(appName) {
    if (!validator.isNonEmptyString(appName)) {
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_APP_NAME, 'Invalid Firebase app name "'.concat(appName, '" provided. App name must be a non-empty string.'));
    }
}
...
function getMetricsHeader() {
    return "gl-node/".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].versions.node, " fire-admin/").concat(getSdkVersion());
}
/**
 ...
 */ function generateUpdateMask(obj) {
    let terminalPaths = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], root = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : '';
    const updateMask = [];
    ...
    for(const key in obj){
        if (typeof obj[key] !== 'undefined') {
            const nextPath = root ? "".concat(root, ".").concat(key) : key;
            // We hit maximum path.
            ...
            if (terminalPaths.indexOf(nextPath) !== -1) {
                ...
                if (maskList.length > 0) {
                    maskList.forEach((mask)=>{
                        updateMask.push("".concat(key, ".").concat(mask));
                    });
                } else {
                    updateMask.push(key);
                }
 ...
 */ function transformMillisecondsToSecondsString(milliseconds) {
    ...
    if (nanos > 0) {
        ...
        duration = "".concat(seconds, ".").concat(nanoString, "s");
    } else {
 ...
 */ function parseResourceName(resourceName, resourceIdKey) {
    ...
    const CHANNEL_NAME_REGEX = new RegExp("^(projects/([^/]+)/)?locations/([^/]+)/".concat(resourceIdKey, "/([^/]+)$"));
...
class DefaultRequestResponse {
    get data() {
        ...
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.UNABLE_TO_PARSE_RESPONSE, 'Error while parsing response data: "'.concat(this.parseError.toString(), '". Raw server ') + 'response: "'.concat(this.text, '". Status code: "').concat(this.status, '". Outgoing ') + 'request: "'.concat(this.request, '."'));
    }
    isJson() {
     ...
     */ constructor(resp){
        ...
        this.request = "".concat(resp.config.method, " ").concat(resp.config.url);
    }
}
/**
...
class RequestResponseError extends Error {
    constructor(response){
        super("Server responded with status ".concat(response.status, "."));
...
class HttpClient extends RequestClient {
     ...
     */ sendWithRetry(config) {
        let retryAttempts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
        return AsyncHttpCall.invoke(config).then((resp)=>{
            ...
            if (err.code === 'ETIMEDOUT') {
                throw new error_1.FirebaseAppError(error_1.AppErrorCodes.NETWORK_TIMEOUT, "Error while making request: ".concat(err.message, "."));
            }
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.NETWORK_ERROR, "Error while making request: ".concat(err.message, ". Error code: ").concat(err.code));
        });
    }
    constructor(retry){
        super(retry);
 ...
 */ class AsyncHttpCall extends AsyncRequestCall {
    ...
    execute() {
        ...
        const timeoutCallback = ()=>{
            req.destroy();
            this.rejectWithError("timeout of ".concat(timeout, "ms exceeded"), 'ETIMEDOUT', req);
        };
        if (timeout) {
 ...
 */ class BaseRequestConfigImpl {
    ...
    buildUrl() {
        ...
        if (!validator.isObject(this.data)) {
            throw new Error("".concat(this.method, " requests cannot have a body"));
        }
...
class AuthorizedHttpClient extends HttpClient {
    send(request) {
        return this.getToken().then((token)=>{
            ...
            requestCopy.headers[authHeader] = "Bearer ".concat(token);
            let quotaProjectId;
    ...
    createSession(url) {
        if (!this.http2Session || this.isClosed) {
            ...
            http2Session.on('goaway', (errorCode, _, opaqueData)=>{
                this.reject(new error_1.FirebaseAppError(error_1.AppErrorCodes.NETWORK_ERROR, "Error while making requests: GOAWAY - ".concat(opaqueData === null || opaqueData === void 0 ? void 0 : opaqueData.toString(), ", Error code: ").concat(errorCode)));
            });
            http2Session.on('error', (error)=>{
                let errorMessage;
                if (error.name == 'AggregateError' && error.errors) {
                    errorMessage = "Session error while making requests: ".concat(error.code, " - ").concat(error.name, ": ") + "[".concat(error.errors.map((error)=>error.message).join(', '), "]");
                } else {
                    errorMessage = "Session error while making requests: ".concat(error.code, " - ").concat(error.message, " ");
                }
 ...
 */ function convertMultiFactorInfoToServerFormat(multiFactorInfo) {
    ...
    if (typeof multiFactorInfo.enrollmentTime !== 'undefined') {
        if (validator.isUTCDateString(multiFactorInfo.enrollmentTime)) {
            ...
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ENROLLMENT_TIME, 'The second factor "enrollmentTime" for "'.concat(multiFactorInfo.uid, '" must be a valid ') + 'UTC date string.');
        }
    }
    ...
    if (isPhoneFactor(multiFactorInfo)) {
        ...
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.UNSUPPORTED_SECOND_FACTOR, 'Unsupported second factor "'.concat(JSON.stringify(multiFactorInfo), '" provided.'));
    }
}
        ...
        switch(options.hash.algorithm){
            ...
            case 'HMAC_MD5':
                if (!validator.isBuffer(options.hash.key)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_KEY, 'A non-empty "hash.key" byte buffer must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                }
                populatedOptions = {
            ...
            case 'SHA512':
                {
                    ...
                    if (isNaN(rounds) || rounds < minRounds || rounds > 8192) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_ROUNDS, 'A valid "hash.rounds" number between '.concat(minRounds, " and 8192 must be provided for ") + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    populatedOptions = {
                        hashAlgorithm: options.hash.algorithm,
                        rounds
            ...
            case 'PBKDF2_SHA256':
                ...
                if (isNaN(rounds) || rounds < 0 || rounds > 120000) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_ROUNDS, 'A valid "hash.rounds" number between 0 and 120000 must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                }
                populatedOptions = {
                    hashAlgorithm: options.hash.algorithm,
                    rounds
            ...
            case 'SCRYPT':
                {
                    if (!validator.isBuffer(options.hash.key)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_KEY, 'A "hash.key" byte buffer must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    rounds = getNumberField(options.hash, 'rounds');
                    if (isNaN(rounds) || rounds <= 0 || rounds > 8) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_ROUNDS, 'A valid "hash.rounds" number between 1 and 8 must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    const memoryCost = getNumberField(options.hash, 'memoryCost');
                    if (isNaN(memoryCost) || memoryCost <= 0 || memoryCost > 14) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_MEMORY_COST, 'A valid "hash.memoryCost" number between 1 and 14 must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
            ...
            case 'STANDARD_SCRYPT':
                {
                    ...
                    if (isNaN(cpuMemCost)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_MEMORY_COST, 'A valid "hash.memoryCost" number must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    const parallelization = getNumberField(options.hash, 'parallelization');
                    if (isNaN(parallelization)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_PARALLELIZATION, 'A valid "hash.parallelization" number must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    const blockSize = getNumberField(options.hash, 'blockSize');
                    if (isNaN(blockSize)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_BLOCK_SIZE, 'A valid "hash.blockSize" number must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    const dkLen = getNumberField(options.hash, 'derivedKeyLength');
                    if (isNaN(dkLen)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_DERIVED_KEY_LENGTH, 'A valid "hash.derivedKeyLength" number must be provided for ' + "hash algorithm ".concat(options.hash.algorithm, "."));
                    }
                    populatedOptions = {
                        hashAlgorithm: options.hash.algorithm,
                        cpuMemCost,
            ...
            default:
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_HASH_ALGORITHM, 'Unsupported hash algorithm provider "'.concat(options.hash.algorithm, '".'));
        }
 ...
 */ class MultiFactorAuthConfig {
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid MultiFactorConfig parameter.'));
            }
        }
        // Validate content.
        ...
        if (typeof options.factorIds !== 'undefined') {
            ...
            options.factorIds.forEach((factorId)=>{
                if (typeof AUTH_FACTOR_CLIENT_TO_SERVER_TYPE[factorId] === 'undefined') {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(factorId, '" is not a valid "AuthFactorType".'));
                }
            });
        }
        if (typeof options.providerConfigs !== 'undefined') {
            ...
            options.providerConfigs.forEach((multiFactorProviderConfig)=>{
                if (typeof multiFactorProviderConfig === 'undefined' || !validator.isObject(multiFactorProviderConfig)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(multiFactorProviderConfig, '" is not a valid "MultiFactorProviderConfig" type.'));
                }
                ...
                for(const key in multiFactorProviderConfig){
                    if (!(key in validProviderConfigKeys)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid ProviderConfig parameter.'));
                    }
                }
                ...
                for(const key in multiFactorProviderConfig.totpProviderConfig){
                    if (!(key in validTotpProviderConfigKeys)) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid TotpProviderConfig parameter.'));
                    }
                }
 ...
 */ function validateTestPhoneNumbers(testPhoneNumbers) {
    ...
    for(const phoneNumber in testPhoneNumbers){
        ...
        if (!validator.isPhoneNumber(phoneNumber)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_TESTING_PHONE_NUMBER, '"'.concat(phoneNumber, '" is not a valid E.164 standard compliant phone number.'));
        }
        // Validate code.
        if (!validator.isString(testPhoneNumbers[phoneNumber]) || !/^[\d]{6}$/.test(testPhoneNumbers[phoneNumber])) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_TESTING_PHONE_NUMBER, '"'.concat(testPhoneNumbers[phoneNumber], '" is not a valid 6 digit code string.'));
        }
    }
}
/**
 ...
 */ class EmailSignInConfig {
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(key, '" is not a valid EmailSignInConfig parameter.'));
            }
        }
        // Validate content.
 ...
 */ class SAMLConfig {
     ...
     */ static buildServerRequest(options) {
        let ignoreMissingFields = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid SAML config parameter.'));
            }
        }
        // Required fields.
 ...
 */ class OIDCConfig {
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid OIDC config parameter.'));
            }
        }
        // Required fields.
        if (validator.isNonEmptyString(options.providerId)) {
        ...
        if (validator.isNonNullObject(options.responseType) && typeof options.responseType !== 'undefined') {
            Object.keys(options.responseType).forEach((key)=>{
                if (!(key in validResponseTypes)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid OAuthResponseType parameter.'));
                }
            });
 ...
 */ class SmsRegionsAuthConfig {
    static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid SmsRegionConfig parameter.'));
            }
        }
        ...
        if (typeof options.allowByDefault !== 'undefined') {
            ...
            for(const key in options.allowByDefault){
                if (!(key in allowByDefaultValidKeys)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid SmsRegionConfig.allowByDefault parameter.'));
                }
            }
        ...
        if (typeof options.allowlistOnly !== 'undefined') {
            ...
            for(const key in options.allowlistOnly){
                if (!(key in allowListOnlyValidKeys)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid SmsRegionConfig.allowlistOnly parameter.'));
                }
            }
 ...
 */ class RecaptchaAuthConfig {
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid RecaptchaConfig parameter.'));
            }
        }
        // Validation
        if (typeof options.emailPasswordEnforcementState !== 'undefined') {
     ...
     */ static validateManagedRule(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid RecaptchaManagedRule parameter.'));
            }
        }
        // Validate content.
     ...
     */ static validateTollFraudManagedRule(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid RecaptchaTollFraudManagedRule parameter.'));
            }
        }
        // Validate content.
        if (typeof options.action !== 'undefined' && options.action !== 'BLOCK') {
     ...
     * @internal
     */ constructor(response){
        const filteredResponse = Object.fromEntries(Object.entries(response).filter((param)=>{
            let [, value] = param;
 ...
 */ class MobileLinksAuthConfig {
    static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid "MobileLinksConfig" parameter.'));
            }
        }
 ...
 */ class PasswordPolicyAuthConfig {
     ...
     */ static buildServerRequest(options) {
        ...
        if (Object.prototype.hasOwnProperty.call(options, 'constraints')) {
            if (options) {
                var _options_constraints, _options_constraints1, _options_constraints2, _options_constraints3, _options_constraints4, _options_constraints5;
                if (((_options_constraints = options.constraints) === null || _options_constraints === void 0 ? void 0 : _options_constraints.requireUppercase) !== undefined) {
                    constraintsRequest.containsUppercaseCharacter = options.constraints.requireUppercase;
                }
                if (((_options_constraints1 = options.constraints) === null || _options_constraints1 === void 0 ? void 0 : _options_constraints1.requireLowercase) !== undefined) {
                    constraintsRequest.containsLowercaseCharacter = options.constraints.requireLowercase;
                }
                if (((_options_constraints2 = options.constraints) === null || _options_constraints2 === void 0 ? void 0 : _options_constraints2.requireNonAlphanumeric) !== undefined) {
                    constraintsRequest.containsNonAlphanumericCharacter = options.constraints.requireNonAlphanumeric;
                }
                if (((_options_constraints3 = options.constraints) === null || _options_constraints3 === void 0 ? void 0 : _options_constraints3.requireNumeric) !== undefined) {
                    constraintsRequest.containsNumericCharacter = options.constraints.requireNumeric;
                }
                if (((_options_constraints4 = options.constraints) === null || _options_constraints4 === void 0 ? void 0 : _options_constraints4.minLength) !== undefined) {
                    constraintsRequest.minPasswordLength = options.constraints.minLength;
                }
                if (((_options_constraints5 = options.constraints) === null || _options_constraints5 === void 0 ? void 0 : _options_constraints5.maxLength) !== undefined) {
     ...
     */ static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid PasswordPolicyConfig parameter.'));
            }
        }
        // Validate content.
        ...
        if (typeof options.constraints !== 'undefined') {
            ...
            for(const key in options.constraints){
                if (!(key in validCharKeys)) {
                    throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid PasswordPolicyConfig.constraints parameter.'));
                }
            }
     ...
     */ constructor(response){
        ...
        if (typeof response.passwordPolicyVersions !== 'undefined') {
            (response.passwordPolicyVersions || []).forEach((policyVersion)=>{
                var _policyVersion_customStrengthOptions, _policyVersion_customStrengthOptions1, _policyVersion_customStrengthOptions2, _policyVersion_customStrengthOptions3, _policyVersion_customStrengthOptions4, _policyVersion_customStrengthOptions5;
                constraintsResponse = {
                    requireLowercase: (_policyVersion_customStrengthOptions = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions === void 0 ? void 0 : _policyVersion_customStrengthOptions.containsLowercaseCharacter,
                    requireUppercase: (_policyVersion_customStrengthOptions1 = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions1 === void 0 ? void 0 : _policyVersion_customStrengthOptions1.containsUppercaseCharacter,
                    requireNonAlphanumeric: (_policyVersion_customStrengthOptions2 = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions2 === void 0 ? void 0 : _policyVersion_customStrengthOptions2.containsNonAlphanumericCharacter,
                    requireNumeric: (_policyVersion_customStrengthOptions3 = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions3 === void 0 ? void 0 : _policyVersion_customStrengthOptions3.containsNumericCharacter,
                    minLength: (_policyVersion_customStrengthOptions4 = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions4 === void 0 ? void 0 : _policyVersion_customStrengthOptions4.minPasswordLength,
                    maxLength: (_policyVersion_customStrengthOptions5 = policyVersion.customStrengthOptions) === null || _policyVersion_customStrengthOptions5 === void 0 ? void 0 : _policyVersion_customStrengthOptions5.maxPasswordLength
                };
            });
        }
 ...
 */ class EmailPrivacyAuthConfig {
    static validate(options) {
        ...
        for(const key in options){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CONFIG, '"'.concat(key, '" is not a valid "EmailPrivacyConfig" parameter.'));
            }
        }
 ...
 */ class Tenant {
     ...
     */ static buildServerRequest(tenantOptions, createRequest) {
        ...
        if (typeof tenantOptions.testPhoneNumbers !== 'undefined') {
            var _tenantOptions_testPhoneNumbers;
            // null will clear existing test phone numbers. Translate to empty object.
            request.testPhoneNumbers = (_tenantOptions_testPhoneNumbers = tenantOptions.testPhoneNumbers) !== null && _tenantOptions_testPhoneNumbers !== void 0 ? _tenantOptions_testPhoneNumbers : {};
        }
     ...
     */ static validate(request, createRequest) {
        ...
        if (!validator.isNonNullObject(request)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(label, '" must be a valid non-null object.'));
        }
        // Check for unsupported top level attributes.
        for(const key in request){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(key, '" is not a valid ').concat(label, " parameter."));
            }
        }
        ...
        if (typeof request.displayName !== 'undefined' && !validator.isNonEmptyString(request.displayName)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(label, '.displayName" must be a valid non-empty string.'));
        }
        ...
        if (typeof request.testPhoneNumbers !== 'undefined' && request.testPhoneNumbers !== null) {
            ...
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(label, '.testPhoneNumbers" must be a non-null object.'));
        }
     ...
     * @returns A JSON-serializable representation of this object.
     */ toJSON() {
        var _this_emailSignInConfig_, _this_multiFactorConfig_;
        const json = {
            tenantId: this.tenantId,
            displayName: this.displayName,
            emailSignInConfig: (_this_emailSignInConfig_ = this.emailSignInConfig_) === null || _this_emailSignInConfig_ === void 0 ? void 0 : _this_emailSignInConfig_.toJSON(),
            multiFactorConfig: (_this_multiFactorConfig_ = this.multiFactorConfig_) === null || _this_multiFactorConfig_ === void 0 ? void 0 : _this_multiFactorConfig_.toJSON(),
...
/*! firebase-admin v13.5.0 */ Object.defineProperty(exports, "__esModule", {
    value: true
});
...
*/ class ProjectConfig {
     ...
     */ static validate(request) {
        ...
        for(const key in request){
            if (!(key in validKeys)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(key, '" is not a valid UpdateProjectConfigRequest parameter.'));
            }
        }
        // Validate SMS Regions Config if provided.
        if (typeof request.smsRegionConfig !== 'undefined') {
...
/** Firebase Auth request header. */ const FIREBASE_AUTH_HEADERS = {
    'X-Client-Version': "Node/Admin/".concat(utils.getSdkVersion())
};
 ...
 */ function validateAuthFactorInfo(request) {
    ...
    if (typeof request.displayName !== 'undefined' && !validator.isString(request.displayName)) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_DISPLAY_NAME, 'The second factor "displayName" for "'.concat(authFactorInfoIdentifier, '" must be a valid string.'));
    }
    ...
    if (typeof request.enrolledAt !== 'undefined' && !validator.isISODateString(request.enrolledAt)) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ENROLLMENT_TIME, 'The second factor "enrollmentTime" for "'.concat(authFactorInfoIdentifier, '" must be a valid ') + 'UTC date string.');
    }
    ...
    if (typeof request.phoneInfo !== 'undefined') {
        ...
        if (!validator.isPhoneNumber(request.phoneInfo)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PHONE_NUMBER, 'The second factor "phoneNumber" for "'.concat(authFactorInfoIdentifier, '" must be a non-empty ') + 'E.164 standard compliant identifier string.');
        }
    } else {
 ...
 */ function validateProviderUserInfo(request) {
    ...
    if (typeof request.displayName !== 'undefined' && typeof request.displayName !== 'string') {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_DISPLAY_NAME, 'The provider "displayName" for "'.concat(request.providerId, '" must be a valid string.'));
    }
    if (!validator.isNonEmptyString(request.rawId)) {
        // This is called localId on the backend but the developer specifies this as
        // uid externally. So the error message should use the client facing name.
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_UID, 'The provider "uid" for "'.concat(request.providerId, '" must be a valid non-empty string.'));
    }
    // email should be a string and a valid email.
    if (typeof request.email !== 'undefined' && !validator.isEmail(request.email)) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_EMAIL, 'The provider "email" for "'.concat(request.providerId, '" must be a valid email string.'));
    }
    // photoUrl should be a URL.
    if (typeof request.photoUrl !== 'undefined' && !validator.isURL(request.photoUrl)) {
        // This is called photoUrl on the backend but the developer specifies this as
        // photoURL externally. So the error message should use the client facing name.
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_PHOTO_URL, 'The provider "photoURL" for "'.concat(request.providerId, '" must be a valid URL string.'));
    }
}
/**
 ...
 */ function validateCreateEditRequest(request, writeOperationType) {
    ...
    if (typeof request.customAttributes !== 'undefined') {
        ...
        if (invalidClaims.length > 0) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.FORBIDDEN_CLAIM, invalidClaims.length > 1 ? 'Developer claims "'.concat(invalidClaims.join('", "'), '" are reserved and cannot be specified.') : 'Developer claim "'.concat(invalidClaims[0], '" is reserved and cannot be specified.'));
        }
        // Check claims payload does not exceed maxmimum size.
        if (request.customAttributes.length > MAX_CLAIMS_PAYLOAD_SIZE) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.CLAIMS_TOO_LARGE, "Developer claims payload should not exceed ".concat(MAX_CLAIMS_PAYLOAD_SIZE, " characters."));
        }
    }
...
.setRequestValidator((request)=>{
    ...
    if (!validator.isNumber(request.maxResults) || request.maxResults <= 0 || request.maxResults > MAX_DOWNLOAD_ACCOUNT_PAGE_SIZE) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, 'Required "maxResults" must be a positive integer that does not exceed ' + "".concat(MAX_DOWNLOAD_ACCOUNT_PAGE_SIZE, "."));
    }
});
/**
...
.setRequestValidator((request)=>{
    ...
    if (exports.EMAIL_ACTION_REQUEST_TYPES.indexOf(request.requestType) === -1) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, '"'.concat(request.requestType, '" is not a supported email action request type.'));
    }
})// Set response validator.
.setResponseValidator((response)=>{
...
.setRequestValidator((request)=>{
    ...
    if (!validator.isNumber(request.pageSize) || request.pageSize <= 0 || request.pageSize > MAX_LIST_PROVIDER_CONFIGURATION_PAGE_SIZE) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, 'Required "maxResults" must be a positive integer that does not exceed ' + "".concat(MAX_LIST_PROVIDER_CONFIGURATION_PAGE_SIZE, "."));
    }
});
/**
 ...
 */ class AbstractAuthRequestHandler {
     ...
     */ downloadAccount() {
        let maxResults = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : MAX_DOWNLOAD_ACCOUNT_PAGE_SIZE, pageToken = arguments.length > 1 ? arguments[1] : void 0;
        // Construct request.
        const request = {
            maxResults,
     ...
     */ uploadAccount(users, options) {
        ...
        if (validator.isArray(users) && users.length > MAX_UPLOAD_ACCOUNT_BATCH_SIZE) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MAXIMUM_USER_COUNT_EXCEEDED, "A maximum of ".concat(MAX_UPLOAD_ACCOUNT_BATCH_SIZE, " users can be imported at once."));
        }
     ...
     */ listOAuthIdpConfigs() {
        let maxResults = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : MAX_LIST_PROVIDER_CONFIGURATION_PAGE_SIZE, pageToken = arguments.length > 1 ? arguments[1] : void 0;
        const request = {
            pageSize: maxResults
        };
...
.setRequestValidator((request)=>{
    ...
    if (!validator.isNumber(request.pageSize) || request.pageSize <= 0 || request.pageSize > MAX_LIST_TENANT_PAGE_SIZE) {
        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, 'Required "maxResults" must be a positive non-zero number that does not exceed ' + "the allowed ".concat(MAX_LIST_TENANT_PAGE_SIZE, "."));
    }
});
 ...
 */ class AuthRequestHandler extends AbstractAuthRequestHandler {
     ...
     *     and no page token are returned.
     */ listTenants() {
        let maxResults = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : MAX_LIST_TENANT_PAGE_SIZE, pageToken = arguments.length > 1 ? arguments[1] : void 0;
        const request = {
            pageSize: maxResults,
            pageToken
        };
     ...
     */ uploadAccount(users, options) {
        ...
        users.forEach((user, index)=>{
            if (validator.isNonEmptyString(user.tenantId) && user.tenantId !== this.tenantId) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MISMATCHING_TENANT_ID, 'UserRecord of index "'.concat(index, '" has mismatching tenant ID "').concat(user.tenantId, '"'));
            }
        });
 ...
 */ class IAMSigner {
     ...
     */ sign(buffer) {
        return this.getAccountId().then((serviceAccount)=>{
            const request = {
                method: 'POST',
                url: "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/".concat(serviceAccount, ":signBlob"),
                data: {
     ...
     */ async getAccountId() {
        ...
        return client.send(request).then((response)=>{
            ...
            throw new CryptoSignerError({
                code: CryptoSignerErrorCode.INVALID_CREDENTIAL,
                message: 'Failed to determine service account. Make sure to initialize ' + 'the SDK with a service account credential. Alternatively specify a service ' + "account with iam.serviceAccounts.signBlob permission. Original error: ".concat(err)
            });
        });
    }
 ...
 */ class FirebaseTokenGenerator {
     ...
     */ createCustomToken(uid, developerClaims) {
            ...
            for(const key in developerClaims){
                /* istanbul ignore else */ if (Object.prototype.hasOwnProperty.call(developerClaims, key)) {
                    if (exports.BLACKLISTED_CLAIMS.indexOf(key) !== -1) {
                        throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, 'Developer claim "'.concat(key, '" is reserved and cannot be specified.'));
                    }
        ...
        return this.signer.getAccountId().then((account)=>{
            ...
            const token = "".concat(this.encodeSegment(header), ".").concat(this.encodeSegment(body));
            ...
            let [token, signature] = param;
            return "".concat(token, ".").concat(this.encodeSegment(signature));
        }).catch((err)=>{
 ...
 */ function handleCryptoSignerError(err) {
    ...
    if (err.code === crypto_signer_1.CryptoSignerErrorCode.SERVER_ERROR && validator.isNonNullObject(err.cause)) {
        ...
        if (validator.isNonNullObject(errorResponse) && errorResponse.error) {
            ...
            const errorMsg = "".concat(errorResponse.error.message, "; ").concat(description);
...
class JwksFetcher {
    ...
    refresh() {
        return this.client.getSigningKeys().then((signingKeys)=>{
            ...
            throw new Error("Error fetching Json Web Keys: ".concat(err.message));
        });
    }
    ...
    refresh() {
        ...
        return client.send(request).then((resp)=>{
            ...
            if (err instanceof api_request_1.RequestResponseError) {
                ...
                if (resp.isJson() && resp.data.error) {
                    errorMessage += "".concat(resp.data.error);
                    if (resp.data.error_description) {
                        errorMessage += ' (' + resp.data.error_description + ')';
                    }
                } else {
                    errorMessage += "".concat(resp.text);
                }
 ...
 */ class FirebaseTokenVerifier {
     ...
     */ verifyJWT(jwtToken) {
        let isEmulator = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
        if (!validator.isString(jwtToken)) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, "First argument to ".concat(this.tokenInfo.verifyApiName, " must be a ").concat(this.tokenInfo.jwtName, " string."));
        }
    ...
    _verifyAuthBlockingToken(jwtToken, isEmulator, audience) {
        ...
        return this.ensureProjectId().then((projectId)=>{
            if (typeof audience === 'undefined') {
                audience = "".concat(projectId, ".cloudfunctions.net/");
            }
    ...
    ensureProjectId() {
        return util.findProjectId(this.app).then((projectId)=>{
            if (!validator.isNonEmptyString(projectId)) {
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_CREDENTIAL, 'Must initialize app with a cert credential or set your Firebase project ID as the ' + "GOOGLE_CLOUD_PROJECT environment variable to call ".concat(this.tokenInfo.verifyApiName, "."));
            }
            return Promise.resolve(projectId);
        });
    }
    ...
    safeDecode(jwtToken) {
        return (0, jwt_1.decodeJwt)(jwtToken).catch((err)=>{
            if (err.code === jwt_1.JwtErrorCode.INVALID_ARGUMENT) {
                const verifyJwtTokenDocsMessage = " See ".concat(this.tokenInfo.url, " ") + "for details on how to retrieve ".concat(this.shortNameArticle, " ").concat(this.tokenInfo.shortName, ".");
                const errorMessage = "Decoding ".concat(this.tokenInfo.jwtName, " failed. Make sure you passed ") + "the entire string JWT which represents ".concat(this.shortNameArticle, " ") + "".concat(this.tokenInfo.shortName, ".") + verifyJwtTokenDocsMessage;
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, errorMessage);
            }
     ...
     */ verifyContent(fullDecodedToken, projectId, isEmulator, audience) {
        ...
        const projectIdMatchMessage = " Make sure the ".concat(this.tokenInfo.shortName, " comes from the same ") + 'Firebase project as the service account used to authenticate this SDK.';
        const verifyJwtTokenDocsMessage = " See ".concat(this.tokenInfo.url, " ") + "for details on how to retrieve ".concat(this.shortNameArticle, " ").concat(this.tokenInfo.shortName, ".");
        let errorMessage;
        if (!isEmulator && typeof header.kid === 'undefined') {
            ...
            if (isCustomToken) {
                errorMessage = "".concat(this.tokenInfo.verifyApiName, " expects ").concat(this.shortNameArticle, " ") + "".concat(this.tokenInfo.shortName, ", but was given a custom token.");
            } else if (isLegacyCustomToken) {
                errorMessage = "".concat(this.tokenInfo.verifyApiName, " expects ").concat(this.shortNameArticle, " ") + "".concat(this.tokenInfo.shortName, ", but was given a legacy custom token.");
            } else {
                errorMessage = "".concat(this.tokenInfo.jwtName, ' has no "kid" claim.');
            }
            errorMessage += verifyJwtTokenDocsMessage;
        } else if (!isEmulator && header.alg !== jwt_1.ALGORITHM_RS256) {
            errorMessage = "".concat(this.tokenInfo.jwtName, ' has incorrect algorithm. Expected "') + jwt_1.ALGORITHM_RS256 + '" but got ' + '"' + header.alg + '".' + verifyJwtTokenDocsMessage;
        } else if (typeof audience !== 'undefined' && !payload.aud.includes(audience)) {
            errorMessage = "".concat(this.tokenInfo.jwtName, ' has incorrect "aud" (audience) claim. Expected "') + audience + '" but got "' + payload.aud + '".' + verifyJwtTokenDocsMessage;
        } else if (typeof audience === 'undefined' && payload.aud !== projectId) {
            errorMessage = "".concat(this.tokenInfo.jwtName, ' has incorrect "aud" (audience) claim. Expected "') + projectId + '" but got "' + payload.aud + '".' + projectIdMatchMessage + verifyJwtTokenDocsMessage;
        } else if (payload.iss !== this.issuer + projectId) {
            errorMessage = "".concat(this.tokenInfo.jwtName, ' has incorrect "iss" (issuer) claim. Expected ') + '"'.concat(this.issuer) + projectId + '" but got "' + payload.iss + '".' + projectIdMatchMessage + verifyJwtTokenDocsMessage;
            ...
            if (typeof payload.sub !== 'string') {
                errorMessage = "".concat(this.tokenInfo.jwtName, ' has no "sub" (subject) claim.') + verifyJwtTokenDocsMessage;
            } else if (payload.sub === '') {
                errorMessage = "".concat(this.tokenInfo.jwtName, ' has an empty "sub" (subject) claim.') + verifyJwtTokenDocsMessage;
            } else if (payload.sub.length > 128) {
                errorMessage = "".concat(this.tokenInfo.jwtName, ' has a "sub" (subject) claim longer than 128 characters.') + verifyJwtTokenDocsMessage;
            }
        }
        if (errorMessage) {
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, errorMessage);
     ...
     */ mapJwtErrorToAuthError(error) {
        ...
        if (error.code === jwt_1.JwtErrorCode.TOKEN_EXPIRED) {
            const errorMessage = "".concat(this.tokenInfo.jwtName, " has expired. Get a fresh ").concat(this.tokenInfo.shortName) + " from your client app and try again (auth/".concat(this.tokenInfo.expiredErrorCode.code, ").") + verifyJwtTokenDocsMessage;
            ...
            const errorMessage = "".concat(this.tokenInfo.jwtName, " has invalid signature.") + verifyJwtTokenDocsMessage;
            ...
            const errorMessage = "".concat(this.tokenInfo.jwtName, ' has "kid" claim which does not ') + "correspond to a known public key. Most likely the ".concat(this.tokenInfo.shortName, " ") + 'is expired, so get a fresh token from your client app and try again.';
            return new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.INVALID_ARGUMENT, errorMessage);
        }
 ...
 */ class BaseAuth {
     ...
     */ verifyIdToken(idToken) {
        let checkRevoked = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
 ...
 */ function validateStringMap(map, label) {
    if (typeof map === 'undefined') {
        ...
        throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_PAYLOAD, "".concat(label, " must be a non-null object"));
    }
    Object.keys(map).forEach((key)=>{
        if (!validator.isString(map[key])) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_PAYLOAD, "".concat(label, " must only contain string values"));
        }
    });
}
/**
 ...
 */ function validateApnsFcmOptions(fcmOptions) {
    ...
    Object.keys(propertyMappings).forEach((key)=>{
        if (key in fcmOptions && propertyMappings[key] in fcmOptions) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_PAYLOAD, "Multiple specifications for ".concat(key, " in ApnsFcmOptions"));
        }
    });
 ...
 */ function validateNotification(notification) {
    ...
    Object.keys(propertyMappings).forEach((key)=>{
        if (key in notification && propertyMappings[key] in notification) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_PAYLOAD, "Multiple specifications for ".concat(key, " in Notification"));
        }
    });
 ...
 */ function validateAps(aps) {
    ...
    Object.keys(propertyMappings).forEach((key)=>{
        if (key in aps && propertyMappings[key] in aps) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_PAYLOAD, "Multiple specifications for ".concat(key, " in Aps"));
        }
    });
 ...
 */ function createFirebaseError(err) {
    ...
    return new error_1.FirebaseMessagingError({
        code: error.code,
        message: "".concat(error.message, ' Raw server response: "').concat(err.response.text, '". Status code: ') + "".concat(err.response.status, ".")
    });
}
/**
 * @param response - The response to check for errors.
...
const FIREBASE_MESSAGING_HEADERS = {
    'X-Firebase-Client': "fire-admin-node/".concat((0, index_1.getSdkVersion)()),
 ...
 */ class Messaging {
    ...
    */ sendEach(messages, dryRun) {
        ...
        if (copy.length > FCM_MAX_BATCH_SIZE) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_ARGUMENT, "messages list must not contain more than ".concat(FCM_MAX_BATCH_SIZE, " items"));
        }
        if (typeof dryRun !== 'undefined' && !validator.isBoolean(dryRun)) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_ARGUMENT, 'dryRun must be a boolean');
        }
        const http2SessionHandler = this.useLegacyTransport ? undefined : new api_request_1.Http2SessionHandler("https://".concat(FCM_SEND_HOST));
        return this.getUrlPath().then((urlPath)=>{
            ...
            http2SessionHandler === null || http2SessionHandler === void 0 ? void 0 : http2SessionHandler.close();
        });
    }
     ...
     */ sendEachForMulticast(message, dryRun) {
        ...
        if (copy.tokens.length > FCM_MAX_BATCH_SIZE) {
            throw new error_1.FirebaseMessagingError(error_1.MessagingClientErrorCode.INVALID_ARGUMENT, "tokens list must not contain more than ".concat(FCM_MAX_BATCH_SIZE, " items"));
        }
    ...
    getUrlPath() {
        ...
        return utils.findProjectId(this.app).then((projectId)=>{
            ...
            this.urlPath = "/v1/projects/".concat(projectId, "/messages:send");
            return this.urlPath;
        });
    }
    /**
     ...
     */ validateRegistrationTokensType(registrationTokenOrTokens, methodName) {
        let errorInfo = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : error_1.MessagingClientErrorCode.INVALID_ARGUMENT;
        if (!validator.isNonEmptyArray(registrationTokenOrTokens) && !validator.isNonEmptyString(registrationTokenOrTokens)) {
            throw new error_1.FirebaseMessagingError(errorInfo, "Registration token(s) provided to ".concat(methodName, "() must be a non-empty string or a ") + 'non-empty array.');
        }
    }
    /**
     ...
     */ validateRegistrationTokens(registrationTokenOrTokens, methodName) {
        ...
        if (validator.isArray(registrationTokenOrTokens)) {
            ...
            if (registrationTokenOrTokens.length > 1000) {
                throw new error_1.FirebaseMessagingError(errorInfo, "Too many registration tokens provided in a single request to ".concat(methodName, "(). Batch ") + 'your requests to contain no more than 1,000 registration tokens per request.');
            }
            ...
            registrationTokenOrTokens.forEach((registrationToken, index)=>{
                if (!validator.isNonEmptyString(registrationToken)) {
                    throw new error_1.FirebaseMessagingError(errorInfo, "Registration token provided to ".concat(methodName, "() at index ").concat(index, " must be a ") + 'non-empty string.');
                }
            });
        }
    }
     ...
     */ validateTopicType(topic, methodName) {
        ...
        if (!validator.isNonEmptyString(topic)) {
            throw new error_1.FirebaseMessagingError(errorInfo, "Topic provided to ".concat(methodName, "() must be a string which matches the format ") + '"/topics/[a-zA-Z0-9-_.~%]+".');
        }
    }
    /**
 ...
 */ class Storage {
     ...
     */ constructor(app){
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STORAGE_EMULATOR_HOST && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.FIREBASE_STORAGE_EMULATOR_HOST) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STORAGE_EMULATOR_HOST = "http://".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.FIREBASE_STORAGE_EMULATOR_HOST);
        }
        let storage;
        try {
            ...
            throw new error_1.FirebaseError({
                ...
                message: 'Failed to import the Cloud Storage client library for Node.js. ' + 'Make sure to install the "@google-cloud/storage" npm package. ' + "Original error: ".concat(err)
            });
        }
...
function getFirebaseMetadata(endpoint, file) {
    const uri = "".concat(endpoint, "/b/").concat(file.bucket.name, "/o/").concat(encodeURIComponent(file.name));
    return new Promise((resolve, reject)=>{
 ...
 */ async function getDownloadURL(file) {
    ...
    return "".concat(endpoint, "/b/").concat(file.bucket.name, "/o/").concat(encodeURIComponent(file.name), "?alt=media&token=").concat(token);
}
}),
...
const FIREBASE_VERSION_HEADER = {
    'X-Firebase-Client': "fire-admin-node/".concat(utils.getSdkVersion())
};
...
function isGcsTfliteModelOptions(options) {
    var _options_tfliteModel;
    const gcsUri = options === null || options === void 0 ? void 0 : (_options_tfliteModel = options.tfliteModel) === null || _options_tfliteModel === void 0 ? void 0 : _options_tfliteModel.gcsTfliteUri;
 ...
 */ class MachineLearningApiClient {
    ...
    updateModel(modelId, model, updateMask) {
        ...
        return this.getProjectUrl().then((url)=>{
            const request = {
                method: 'PATCH',
                url: "".concat(url, "/models/").concat(modelId, "?updateMask=").concat(updateMask.join()),
                data: model
            };
            return this.sendRequest(request);
        });
    ...
    deleteModel(modelId) {
        return this.getProjectUrl().then((url)=>{
            ...
            const request = {
                method: 'DELETE',
                url: "".concat(url, "/").concat(modelName)
            };
            return this.sendRequest(request);
        });
    }
     ...
     */ handleOperation(op, options) {
        ...
        if (!metadataType.includes('ModelOperationMetadata')) {
            throw new machine_learning_utils_1.FirebaseMachineLearningError('invalid-server-response', "Unknown Metadata type: ".concat(JSON.stringify(metadata)));
        }
    ...
    pollOperationWithExponentialBackoff(opName, options) {
        var _options_maxTimeMillis;
        const maxTimeMilliseconds = (_options_maxTimeMillis = options === null || options === void 0 ? void 0 : options.maxTimeMillis) !== null && _options_maxTimeMillis !== void 0 ? _options_maxTimeMillis : POLL_DEFAULT_MAX_TIME_MILLISECONDS;
        var _options_baseWaitMillis;
        const baseWaitMillis = (_options_baseWaitMillis = options === null || options === void 0 ? void 0 : options.baseWaitMillis) !== null && _options_baseWaitMillis !== void 0 ? _options_baseWaitMillis : POLL_BASE_WAIT_TIME_MILLISECONDS;
        var _options_maxWaitMillis;
        const maxWaitMillis = (_options_maxWaitMillis = options === null || options === void 0 ? void 0 : options.maxWaitMillis) !== null && _options_maxWaitMillis !== void 0 ? _options_maxWaitMillis : POLL_MAX_WAIT_TIME_MILLISECONDS;
     ...
     */ getResourceWithFullName(fullName) {
        const request = {
            method: 'GET',
            url: "".concat(ML_V1BETA2_API, "/").concat(fullName)
        };
        return this.sendRequest(request);
    }
    sendRequest(request) {
    ...
    toFirebaseError(err) {
        ...
        const response = err.response;
        if (!response.isJson()) {
            return new machine_learning_utils_1.FirebaseMachineLearningError('unknown-error', "Unexpected response with status: ".concat(response.status, " and body: ").concat(response.text));
        }
        ...
        const message = error.message || "Unknown server error: ".concat(response.text);
    ...
    getProjectUrl() {
        return this.getProjectIdPrefix().then((projectIdPrefix)=>{
            return "".concat(ML_V1BETA2_API, "/").concat(projectIdPrefix);
        });
    }
    getProjectIdPrefix() {
        ...
        return utils.findProjectId(this.app).then((projectId)=>{
            ...
            this.projectIdPrefix = "projects/".concat(projectId);
 ...
 */ class MachineLearning {
     ...
     */ listModels() {
        ...
        return this.client.listModels(options).then((resp)=>{
            if (!validator.isNonNullObject(resp)) {
                throw new machine_learning_utils_1.FirebaseMachineLearningError('invalid-argument', "Invalid ListModels response: ".concat(JSON.stringify(resp)));
            }
            let models = [];
            if (resp.models) {
    ...
    signUrlIfPresent(options) {
        ...
        if ((0, machine_learning_api_client_1.isGcsTfliteModelOptions)(modelOptions)) {
            return this.signUrl(modelOptions.tfliteModel.gcsTfliteUri).then((uri)=>{
                ...
                throw new machine_learning_utils_1.FirebaseMachineLearningError('internal-error', "Error during signing upload url: ".concat(err.message));
            });
        }
    ...
    signUrl(unsignedUrl) {
        ...
        if (!matches) {
            throw new machine_learning_utils_1.FirebaseMachineLearningError('invalid-argument', "Invalid unsigned url: ".concat(unsignedUrl));
        }
 ...
 */ class Model {
    ...
    /** Error message when model validation fails. */ get validationError() {
        var _this_model_state_validationError, _this_model_state;
        return (_this_model_state = this.model.state) === null || _this_model_state === void 0 ? void 0 : (_this_model_state_validationError = _this_model_state.validationError) === null || _this_model_state_validationError === void 0 ? void 0 : _this_model_state_validationError.message;
    }
    /** True if the model is published. */ get published() {
        var _this_model_state;
        return ((_this_model_state = this.model.state) === null || _this_model_state === void 0 ? void 0 : _this_model_state.published) || false;
    }
    /**
     ...
     */ get locked() {
        var _this_model_activeOperations;
        var _this_model_activeOperations_length;
        return ((_this_model_activeOperations_length = (_this_model_activeOperations = this.model.activeOperations) === null || _this_model_activeOperations === void 0 ? void 0 : _this_model_activeOperations.length) !== null && _this_model_activeOperations_length !== void 0 ? _this_model_activeOperations_length : 0) > 0;
    }
    /**
     ...
     */ waitForUnlocked(maxTimeMillis) {
        var _this_model_activeOperations;
        var _this_model_activeOperations_length;
        if (((_this_model_activeOperations_length = (_this_model_activeOperations = this.model.activeOperations) === null || _this_model_activeOperations === void 0 ? void 0 : _this_model_activeOperations.length) !== null && _this_model_activeOperations_length !== void 0 ? _this_model_activeOperations_length : 0) > 0) {
    ...
    static validateAndClone(model) {
        if (!validator.isNonNullObject(model) || !validator.isNonEmptyString(model.name) || !validator.isNonEmptyString(model.createTime) || !validator.isNonEmptyString(model.updateTime) || !validator.isNonEmptyString(model.displayName) || !validator.isNonEmptyString(model.etag)) {
            throw new machine_learning_utils_1.FirebaseMachineLearningError('invalid-server-response', "Invalid Model response: ".concat(JSON.stringify(model)));
        }
 ...
 */ class FirebaseInstallationsRequestHandler {
     ...
     */ invokeRequestHandler(apiSettings) {
        return this.getPathPrefix().then((path)=>{
            const req = {
                url: "https://".concat(this.host).concat(path).concat(apiSettings.getEndpoint()),
                method: apiSettings.getHttpMethod(),
        ...
        // return nothing on success
            ...
            if (err instanceof api_request_1.RequestResponseError) {
                ...
                const message = template ? 'Installation ID "'.concat(apiSettings.getEndpoint(), '": ').concat(template) : errorMessage;
    ...
    getPathPrefix() {
        ...
        return utils.findProjectId(this.app).then((projectId)=>{
            ...
            this.path = FIREBASE_IID_PATH + "project/".concat(projectId, "/instanceId/");
            return this.path;
        });
    }
    /**
...
/** Project management request header. */ const PROJECT_MANAGEMENT_HEADERS = {
    'X-Client-Version': "Node/Admin/".concat((0, index_1.getSdkVersion)())
};
...
function assertServerResponse(condition, responseData, message) {
    if (!condition) {
        throw new error_1.FirebaseProjectManagementError('invalid-server-response', "".concat(message, " Response data: ").concat(JSON.stringify(responseData, null, 2)));
    }
}
/**
 ...
 */ class ProjectManagementRequestHandler {
    static wrapAndRethrowHttpError(errStatusCode, errText) {
        ...
        throw new error_1.FirebaseProjectManagementError(errorCode, "".concat(errorMessage, " Status code: ").concat(errStatusCode, '. Raw server response: "').concat(errText, '".'));
    }
    /**
     ...
     */ listAndroidApps(parentResourceName) {
        return this.invokeRequestHandler('GET', "".concat(parentResourceName, "/androidApps?page_size=").concat(LIST_APPS_MAX_PAGE_SIZE), /* requestData */ null, 'v1beta1');
    }
    /**
     * @param parentResourceName - Fully-qualified resource name of the project whose iOS apps
     *     you want to list.
     */ listIosApps(parentResourceName) {
        return this.invokeRequestHandler('GET', "".concat(parentResourceName, "/iosApps?page_size=").concat(LIST_APPS_MAX_PAGE_SIZE), /* requestData */ null, 'v1beta1');
    }
    /**
     * @param parentResourceName - Fully-qualified resource name of the project whose iOS apps
     *     you want to list.
     */ listAppMetadata(parentResourceName) {
        return this.invokeRequestHandler('GET', "".concat(parentResourceName, ":searchApps?page_size=").concat(LIST_APPS_MAX_PAGE_SIZE), /* requestData */ null, 'v1beta1');
    }
    /**
     ...
     */ createAndroidApp(parentResourceName, packageName, displayName) {
        ...
        return this.invokeRequestHandler('POST', "".concat(parentResourceName, "/androidApps"), requestData, 'v1beta1').then((responseData)=>{
     ...
     */ createIosApp(parentResourceName, bundleId, displayName) {
        ...
        return this.invokeRequestHandler('POST', "".concat(parentResourceName, "/iosApps"), requestData, 'v1beta1').then((responseData)=>{
     ...
     */ setDisplayName(resourceName, newDisplayName) {
        ...
        return this.invokeRequestHandler('PATCH', "".concat(resourceName, "?update_mask=display_name"), requestData, 'v1beta1').then(()=>undefined);
    }
    /**
     ...
     */ getAndroidShaCertificates(parentResourceName) {
        return this.invokeRequestHandler('GET', "".concat(parentResourceName, "/sha"), /* requestData */ null, 'v1beta1');
    }
    /**
     ...
     */ addAndroidShaCertificate(parentResourceName, certificate) {
        ...
        return this.invokeRequestHandler('POST', "".concat(parentResourceName, "/sha"), requestData, 'v1beta1').then(()=>undefined);
    }
    /**
     * @param parentResourceName - Fully-qualified resource name of the app whose config you
     *     want to get.
     */ getConfig(parentResourceName) {
        return this.invokeRequestHandler('GET', "".concat(parentResourceName, "/config"), /* requestData */ null, 'v1beta1');
    }
    /**
     ...
     */ invokeRequestHandler(method, path, requestData) {
        let apiVersion = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'v1';
        const baseUrlToUse = apiVersion === 'v1' ? this.baseUrl : this.baseBetaUrl;
        const request = {
            method,
            url: "".concat(baseUrlToUse).concat(path),
     ...
     * @constructor
     */ constructor(app){
        this.baseUrl = "https://".concat(PROJECT_MANAGEMENT_HOST_AND_PORT).concat(PROJECT_MANAGEMENT_PATH);
        this.baseBetaUrl = "https://".concat(PROJECT_MANAGEMENT_HOST_AND_PORT).concat(PROJECT_MANAGEMENT_BETA_PATH);
        this.httpClient = new api_request_1.AuthorizedHttpClient(app);
    }
}
 ...
 */ class AndroidApp {
     ...
     */ getMetadata() {
        return this.requestHandler.getResource(this.resourceName).then((responseData)=>{
            ...
            requiredFieldsList.forEach((requiredField)=>{
                (0, project_management_api_request_internal_1.assertServerResponse)(validator.isNonEmptyString(responseData[requiredField]), responseData, "getMetadata()'s responseData.".concat(requiredField, " must be a non-empty string."));
            });
            const metadata = {
     ...
     */ getShaCertificates() {
        return this.requestHandler.getAndroidShaCertificates(this.resourceName).then((responseData)=>{
            ...
            return responseData.certificates.map((certificateJson)=>{
                requiredFieldsList.forEach((requiredField)=>{
                    (0, project_management_api_request_internal_1.assertServerResponse)(validator.isNonEmptyString(certificateJson[requiredField]), responseData, "getShaCertificates()'s responseData.certificates[].".concat(requiredField, " must be a ") + 'non-empty string.');
                });
     ...
     */ constructor(appId, requestHandler){
        ...
        this.resourceName = "projects/-/androidApps/".concat(appId);
    }
}
 ...
 */ class IosApp {
     ...
     */ constructor(appId, requestHandler){
        ...
        this.resourceName = "projects/-/iosApps/".concat(appId);
    }
}
 ...
 */ class ProjectManagement {
     ...
     */ listPlatformApps(platform, callerName) {
        return this.getResourceName().then((resourceName)=>{
            ...
            return responseData.apps.map((appJson)=>{
                (0, project_management_api_request_internal_1.assertServerResponse)(validator.isNonEmptyString(appJson.appId), responseData, '"apps[].appId" field must be present in the '.concat(callerName, " response data."));
                if (platform === 'android') {
    ...
    assertListAppsResponseData(responseData, callerName) {
        (0, project_management_api_request_internal_1.assertServerResponse)(validator.isNonNullObject(responseData), responseData, "".concat(callerName, "'s responseData must be a non-null object."));
        if (responseData.apps) {
            (0, project_management_api_request_internal_1.assertServerResponse)(validator.isArray(responseData.apps), responseData, '"apps" field must be present in the '.concat(callerName, " response data."));
        }
    }
    /**
 ...
 */ class SecurityRulesApiClient {
    ...
    createRuleset(ruleset) {
        ...
        for (const rf of ruleset.source.files){
            if (!validator.isNonNullObject(rf) || !validator.isNonEmptyString(rf.name) || !validator.isNonEmptyString(rf.content)) {
                const err = new security_rules_internal_1.FirebaseSecurityRulesError('invalid-argument', "Invalid rules file argument: ".concat(JSON.stringify(rf)));
                return Promise.reject(err);
            }
        }
    ...
    deleteRuleset(name) {
        return this.getUrl().then((url)=>{
            ...
            const request = {
                method: 'DELETE',
                url: "".concat(url, "/").concat(rulesetName)
            };
            return this.sendRequest(request);
        });
    }
    listRulesets() {
        let pageSize = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 100, pageToken = arguments.length > 1 ? arguments[1] : void 0;
    ...
    getRelease(name) {
        return this.getResource("releases/".concat(name));
    }
    updateOrCreateRelease(name, rulesetName) {
        return this.updateRelease(name, rulesetName).catch((error)=>{
            ...
            if (error.code === "security-rules/".concat(ERROR_CODE_MAPPING.NOT_FOUND)) {
    ...
    updateRelease(name, rulesetName) {
        return this.getUrl().then((url)=>{
            return this.getReleaseDescription(name, rulesetName).then((release)=>{
                const request = {
                    method: 'PATCH',
                    url: "".concat(url, "/releases/").concat(name),
                    data: {
                        release
                    }
                };
    ...
    getUrl() {
        return this.getProjectIdPrefix().then((projectIdPrefix)=>{
            return "".concat(RULES_V1_API, "/").concat(projectIdPrefix);
        });
    }
    getProjectIdPrefix() {
        if (this.projectIdPrefix) {
    ...
    getReleaseDescription(name, rulesetName) {
        return this.getProjectIdPrefix().then((projectIdPrefix)=>{
            return {
                name: "".concat(projectIdPrefix, "/releases/").concat(name),
                rulesetName: "".concat(projectIdPrefix, "/").concat(this.getRulesetName(rulesetName))
            };
        });
    }
    getRulesetName(name) {
    ...
    toFirebaseError(err) {
        ...
        const response = err.response;
        if (!response.isJson()) {
            return new security_rules_internal_1.FirebaseSecurityRulesError('unknown-error', "Unexpected response with status: ".concat(response.status, " and body: ").concat(response.text));
        }
        const error = response.data.error || {};
        let code = 'unknown-error';
        if (error.status && error.status in ERROR_CODE_MAPPING) {
 ...
 */ class RulesetMetadataList {
     ...
     */ constructor(response){
        if (!validator.isNonNullObject(response) || !validator.isArray(response.rulesets)) {
            throw new security_rules_internal_1.FirebaseSecurityRulesError('invalid-argument', "Invalid ListRulesets response: ".concat(JSON.stringify(response)));
        }
 ...
 */ class Ruleset {
     ...
     */ constructor(ruleset){
        if (!validator.isNonNullObject(ruleset) || !validator.isNonEmptyString(ruleset.name) || !validator.isNonEmptyString(ruleset.createTime) || !validator.isNonNullObject(ruleset.source)) {
            throw new security_rules_internal_1.FirebaseSecurityRulesError('invalid-argument', "Invalid Ruleset response: ".concat(JSON.stringify(ruleset)));
        }
 ...
 */ class SecurityRules {
     ...
     */ getStorageRuleset(bucket) {
        return Promise.resolve().then(()=>{
            ...
            return this.getRulesetForRelease("".concat(SecurityRules.FIREBASE_STORAGE, "/").concat(bucketName));
        });
    }
    /**
     * Creates a new {@link Ruleset} from the given
     ...
     */ releaseStorageRuleset(ruleset, bucket) {
        return Promise.resolve().then(()=>{
            ...
            return this.releaseRuleset(ruleset, "".concat(SecurityRules.FIREBASE_STORAGE, "/").concat(bucketName));
        });
    }
    /**
     ...
     */ listRulesetMetadata() {
        let pageSize = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 100, nextPageToken = arguments.length > 1 ? arguments[1] : void 0;
    ...
    getRulesetForRelease(releaseName) {
        return this.client.getRelease(releaseName).then((release)=>{
            ...
            if (!validator.isNonEmptyString(rulesetName)) {
                throw new security_rules_internal_1.FirebaseSecurityRulesError('not-found', "Ruleset name not found for ".concat(releaseName, "."));
            }
 ...
 */ class RemoteConfigApiClient {
    ...
    rollback(versionNumber) {
        ...
        return this.getUrl().then((url)=>{
            const request = {
                method: 'POST',
                url: "".concat(url, "/remoteConfig:rollback"),
                headers: FIREBASE_REMOTE_CONFIG_HEADERS,
                data
            };
            return this.httpClient.send(request);
    ...
    listVersions(options) {
        ...
        return this.getUrl().then((url)=>{
            const request = {
                method: 'GET',
                url: "".concat(url, "/remoteConfig:listVersions"),
                headers: FIREBASE_REMOTE_CONFIG_HEADERS,
                data: options
            };
            return this.httpClient.send(request);
    ...
    getServerTemplate() {
        return this.getUrl().then((url)=>{
            const request = {
                method: 'GET',
                url: "".concat(url, "/namespaces/firebase-server/serverRemoteConfig"),
                headers: FIREBASE_REMOTE_CONFIG_HEADERS
            };
            return this.httpClient.send(request);
        }).then((resp)=>{
    ...
    getUrl() {
        return this.getProjectIdPrefix().then((projectIdPrefix)=>{
            return "".concat(FIREBASE_REMOTE_CONFIG_URL_BASE, "/v1/").concat(projectIdPrefix);
        });
    }
    getProjectIdPrefix() {
        if (this.projectIdPrefix) {
    ...
    toFirebaseError(err) {
        ...
        const response = err.response;
        if (!response.isJson()) {
            return new FirebaseRemoteConfigError('unknown-error', "Unexpected response with status: ".concat(response.status, " and body: ").concat(response.text));
        }
        const error = response.data.error || {};
        let code = 'unknown-error';
        if (error.status && error.status in ERROR_CODE_MAPPING) {
     ...
     */ validateInputRemoteConfigTemplate(template) {
        ...
        if (!validator.isNonNullObject(templateCopy)) {
            throw new FirebaseRemoteConfigError('invalid-argument', "Invalid Remote Config template: ".concat(JSON.stringify(templateCopy)));
        }
     ...
     */ validateVersionNumber(versionNumber) {
        let propertyName = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 'versionNumber';
        if (!validator.isNonEmptyString(versionNumber) && !validator.isNumber(versionNumber)) {
            throw new FirebaseRemoteConfigError('invalid-argument', "".concat(propertyName, " must be a non-empty string in int64 format or a number"));
        }
        if (!Number.isInteger(Number(versionNumber))) {
            throw new FirebaseRemoteConfigError('invalid-argument', "".concat(propertyName, " must be an integer or a string in int64 format"));
        }
 ...
 */ class ConditionEvaluator {
    ...
    evaluateCondition(condition, context) {
        let nestingLevel = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
    ...
    evaluatePercentCondition(percentCondition, context) {
        ...
        const normalizedMicroPercentUpperBound = (microPercentRange === null || microPercentRange === void 0 ? void 0 : microPercentRange.microPercentUpperBound) || 0;
        const normalizedMicroPercentLowerBound = (microPercentRange === null || microPercentRange === void 0 ? void 0 : microPercentRange.microPercentLowerBound) || 0;
        const seedPrefix = seed && seed.length > 0 ? "".concat(seed, ".") : '';
        const stringToHash = "".concat(seedPrefix).concat(context.randomizationId);
 ...
 */ class RemoteConfig {
     ...
     */ listVersions(options) {
        return this.client.listVersions(options).then((listVersionsResponse)=>{
            var _listVersionsResponse_versions;
            var _listVersionsResponse_versions_map;
            return {
                versions: (_listVersionsResponse_versions_map = (_listVersionsResponse_versions = listVersionsResponse.versions) === null || _listVersionsResponse_versions === void 0 ? void 0 : _listVersionsResponse_versions.map((version)=>new VersionImpl(version))) !== null && _listVersionsResponse_versions_map !== void 0 ? _listVersionsResponse_versions_map : [],
     ...
     */ createTemplateFromJSON(json) {
        ...
        try {
            ...
            throw new remote_config_api_client_internal_1.FirebaseRemoteConfigError('invalid-argument', "Failed to parse the JSON string: ".concat(json, ". ") + e);
        }
     ...
     */ initServerTemplate(options) {
        const template = new ServerTemplateImpl(this.client, new condition_evaluator_internal_1.ConditionEvaluator(), options === null || options === void 0 ? void 0 : options.defaultConfig);
        if (options === null || options === void 0 ? void 0 : options.template) {
            template.set(options === null || options === void 0 ? void 0 : options.template);
        }
        return template;
    }
    /**
 ...
 */ class RemoteConfigTemplateImpl {
    ...
    constructor(config){
        if (!validator.isNonNullObject(config) || !validator.isNonEmptyString(config.etag)) {
            throw new remote_config_api_client_internal_1.FirebaseRemoteConfigError('invalid-argument', "Invalid Remote Config template: ".concat(JSON.stringify(config)));
        }
     ...
     */ set(template) {
        ...
        if (validator.isString(template)) {
            try {
                ...
                throw new remote_config_api_client_internal_1.FirebaseRemoteConfigError('invalid-argument', "Failed to parse the JSON string: ".concat(template, ". ") + e);
            }
        } else {
            parsed = template;
        }
 ...
 */ class ServerTemplateDataImpl {
    constructor(template){
        if (!validator.isNonNullObject(template) || !validator.isNonEmptyString(template.etag)) {
            throw new remote_config_api_client_internal_1.FirebaseRemoteConfigError('invalid-argument', "Invalid Remote Config template: ".concat(JSON.stringify(template)));
        }
...
*/ class VersionImpl {
    ...
    constructor(version){
        if (!validator.isNonNullObject(version)) {
            throw new remote_config_api_client_internal_1.FirebaseRemoteConfigError('invalid-argument', "Invalid Remote Config version instance: ".concat(JSON.stringify(version)));
        }
 ...
 */ class AppCheckApiClient {
    ...
    verifyReplayProtection(token) {
        ...
        return this.getVerifyTokenUrl().then((url)=>{
            ...
            var _resp_data;
            if (typeof resp.data.alreadyConsumed !== 'undefined' && !validator.isBoolean((_resp_data = resp.data) === null || _resp_data === void 0 ? void 0 : _resp_data.alreadyConsumed)) {
    ...
    toFirebaseError(err) {
        ...
        const response = err.response;
        if (!response.isJson()) {
            return new FirebaseAppCheckError('unknown-error', "Unexpected response with status: ".concat(response.status, " and body: ").concat(response.text));
        }
        const error = response.data.error || {};
        let code = 'unknown-error';
 ...
 */ function appCheckErrorFromCryptoSignerError(err) {
    ...
    if (err.code === crypto_signer_1.CryptoSignerErrorCode.SERVER_ERROR && validator.isNonNullObject(err.cause)) {
        ...
        if (errorResponse === null || errorResponse === void 0 ? void 0 : errorResponse.error) {
            ...
            return new app_check_api_client_internal_1.FirebaseAppCheckError(code, "Error returned from server while signing a custom token: ".concat(description));
        }
 ...
 */ class AppCheckTokenVerifier {
     ...
     */ verifyContent(fullDecodedToken, projectId) {
        ...
        const scopedProjectId = "projects/".concat(projectId);
        let errorMessage;
 ...
 */ class AppCheck {
     ...
     */ verifyToken(appCheckToken, options) {
        ...
        return this.appCheckTokenVerifier.verifyToken(appCheckToken).then((decodedToken)=>{
            if (options === null || options === void 0 ? void 0 : options.consume) {
 ...
 */ class DatabaseRulesClient {
    ...
    getErrorMessage(err) {
        ...
        try {
            ...
            if (body && body.error) {
                return "".concat(intro, ": ").concat(body.error.trim());
            }
        } catch (e) {
        // Ignore parsing errors
        }
        return "".concat(intro, ": ").concat(err.response.text);
    }
    constructor(app, dbUrl){
        ...
        if (emulatorHost) {
            ...
            parsedUrl = new url_1.URL("http://".concat(emulatorHost, "?ns=").concat(namespace));
        }
...
class FirestoreService {
    initializeDatabase(databaseId, settings) {
        ...
        if (existingInstance) {
            var _this_firestoreSettings_get;
            const initialSettings = (_this_firestoreSettings_get = this.firestoreSettings.get(databaseId)) !== null && _this_firestoreSettings_get !== void 0 ? _this_firestoreSettings_get : {};
    ...
    checkIfSameSettings(settingsA, settingsB) {
        const a = settingsA !== null && settingsA !== void 0 ? settingsA : {};
        const b = settingsB !== null && settingsB !== void 0 ? settingsB : {};
...
function getFirestoreOptions(app, firestoreSettings) {
    ...
    const preferRest = firestoreSettings === null || firestoreSettings === void 0 ? void 0 : firestoreSettings.preferRest;
    if (credential instanceof credential_internal_1.ServiceAccountCredential) {
        return {
            credentials: {
                private_key: credential.privateKey,
...
function initFirestore(app, databaseId, firestoreSettings) {
    ...
    try {
        ...
        throw new error_1.FirebaseFirestoreError({
            ...
            message: 'Failed to import the Cloud Firestore client library for Node.js. ' + 'Make sure to install the "@google-cloud/firestore" npm package. ' + "Original error: ".concat(err)
        });
    }
...
function initializeFirestore(app, settings, databaseId) {
    ...
    databaseId !== null && databaseId !== void 0 ? databaseId : databaseId = path_1.DEFAULT_DATABASE_ID;
    const firebaseApp = app;
    const firestoreService = firebaseApp.getOrInitService('firestore', (app)=>new firestore_internal_1.FirestoreService(app));
