...
function Header(param) {
    ...
    const displayName = (userData === null || userData === void 0 ? void 0 : userData.name) ? userData.name.split(' ')[0] : 'Usuario';
...
async function getCurrentUser() {
    ...
    const sessionCookie = ((_this = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cookies"])().get('session')) === null || _this === void 0 ? void 0 : _this.value) || '';
    ...
    try {
        ...
        const decodedClaims = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth().verifySessionCookie(sessionCookie, true);
...
//# sourceMappingURL=src_8cc0d1a4._.js.map