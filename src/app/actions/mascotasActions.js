 ...
 * @param {string} userId - El ID del usuario al que pertenece la mascota.
 ...
 */
export async function registrarMascota(userId, mascotaData) {
    if (!userId || !mascotaData) {
    ...
    try {
      ...
      if (enAdopcion) {
        ...
        revalidatePath('/'); // <--- ¡ESTA ES LA LÍNEA CLAVE QUE FALTABA!
      }
